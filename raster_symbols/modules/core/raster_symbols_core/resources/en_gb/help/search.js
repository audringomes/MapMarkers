// SKIN SOURCE
// MODIFIED by RWSP at 5/Oct/2017 to change order and add <br> in form
//
// ----------------------------------------------------------------------------
...
//	document.writeln(STR_FORM_SEARCHFOR + " <input type=\"text\" name=\"zoom_query\" size=\"20\" value=\"" + htmlspecialchars(query) + "\" id=\"zoom_searchbox\" class=\"zoom_searchbox\" />");
	document.writeln(STR_FORM_SEARCHFOR + " <input type=\"text\" name=\"zoom_query\" size=\"30\" value=\"" + htmlspecialchars(query) + "\" id=\"zoom_searchbox\" class=\"zoom_searchbox\" />");
// RWSP END MOD
}
