    ...
    for (var i=0; i<terms.length; i++) // take each term in turn
    {
        ...
        {        	        	
            ...
            do 
            {
                l=text.length;
// RWSP BEGIN CHANGE
// Remove setting the style element, because the rwsp routine uses span class css  
// RWSP CHANGED text=text.replace(re, '$1<span style="background:#FFFF40;" class="highlight" id="highlight" name="highlight">$2</span id="highlight">$3');
